    ...
    <div className={styles.loading__arrow}>
        <svg width="159" height="18" viewBox="0 0 159 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                ...
                fill="white"/>
            <defs>
                <linearGradient id="paint0_linear_952_6" x1="0" y1="0" x2="124" y2="-1.00117e-08"
    ...
    return (
        <div {...props} className={cn(styles.loading, className)}>
            <div className={styles.loading__elements}>
                <TheArrow/>
                <div data-text={`${isLoaded ? 'loaded' : `loading${dots}`}`} className={styles.loading__line}>
                    <div ref={line} className={classNames(styles.line_active, {[styles.line_success]: isLoaded})}></div>
                </div>
                <TheArrow/>
            </div>
        </div>
