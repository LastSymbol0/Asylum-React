...
const Header = () => {
  ...
  useEffect(() => {
    ...
    const elementLeft = renderer.getElementCoords(
      navButtons.current[activeNumber]
    ).left
  ...
  function resize() {
    setDimension({ x: window.innerWidth })
  }
