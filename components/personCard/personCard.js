        ...
        <div className={styles.personCard__social}>
            {social.map((_, i) => (
                <a key={i} href={_.link} target="_blank" rel="noreferrer">
                    <svg className={styles.social__circle} width="28" height="28" viewBox="0 0 28 28" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                        <circle cx="14" cy="14" r="13" fill="#161616" stroke="#BABABA"/>
                        <circle className={styles.circle_gradient} cx="14" cy="14" r="13" fill="#161616"
                                stroke="url(#gradient)"/>
                        <defs>
                            <linearGradient id="gradient" x1="-9.57669" y1="48.7259" x2="25.059" y2="-2.04514"
    ...
    return (
        <div {...props} className={cn(styles.personCard, className)}>
            <div className={styles.personCard__avatar}>
                ...
                <Image className={styles.avatar__image} priority={true} src={avatar} alt=""/>
            </div>
